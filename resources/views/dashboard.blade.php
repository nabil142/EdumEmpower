  ...
            </div>
            ...
            <div class="main-content">
                ...
                <div class="section-job-section">
                    ...
                    <div class="cards-container-work2">
                    ...
                    <div class="cards-container-work3">
                        <div class="job-card-spotify">
                            <div class="company-info-spotify">
                                <img src="/Source/facebook-logo.png" alt="facebook logo" class="company-logo-facebook">
                                <div class="job-details-spotify">
                                    <p class="company-spotify">Facebook</p>
                                    <p class="date-spotify">November 12, 2024</p>
                                </div>
                            </div>
                            <h3 class= "h3-facebook">Backend Developer</h3>
                            <div class="tags-spotify">
                                <span1 class="tag1-spotify">Design</span1>
                                <span class="tag-spotify">Full Time</span>
                            </div>
                            <div class="location-salary-spotify">
                                <div class="location-spotify">
                                    <span class="icon-spotify">📍</span>
                    ...
                    <div class="cards-container-work4">
                        <div class="job-card-spotify">
                            <div class="company-info-spotify">
                                <img src="/Source/youtube-logo.png" alt="facebook logo" class="company-logo-youtube">
                                <div class="job-details-spotify">
                                    <p class="company-spotify">Youtube</p>
                                    <p class="date-spotify">March 25, 2025</p>
                                </div>
                            </div>
                            <h3 class= "h3-youtube">Strategic Partner Manager</h3>
                            <div class="tags-spotify">
                                <span1 class="tag1-spotify">Business</span1>
                                <span class="tag-spotify">Full Time</span>
                            </div>
                    ...
                    <div class="cards-container-work5">
                        <div class="job-card-spotify">
                            <div class="company-info-spotify">
                                <img src="/Source/paypal-logo.png" alt="paypal logo" class="company-logo-paypal">
                                <div class="job-details-spotify">
                                    <p class="company-spotify">Youtube</p>
                                    <p class="date-spotify">March 25, 2025</p>
                                </div>
                            </div>
                            <h3 class= "h3-paypal">System Administrator</h3>
                            <div class="tags-spotify">
                                <span1 class="tag1-spotify">Business</span1>
                                <span class="tag-spotify">Casual</span>
                            </div>
                    ...
                    <div class="cards-container-work6">
                        <div class="job-card-spotify">
                            <div class="company-info-spotify">
                                <img src="/Source/twitter-logo.png" alt="twitter logo" class="company-logo-twitter">
                                <div class="job-details-spotify">
                                    <p class="company-spotify">X</p>
                                    <p class="date-spotify">May 5, 2025</p>
                                </div>
                            </div>
                            <h3 class= "h3-youtube">Lead Technical Architect</h3>
                            <div class="tags-spotify">
                                <span1 class="tag1-spotify">Technology</span1>
                                <span class="tag-spotify">Full Time</span>
                            </div>
                            <div class="location-salary-spotify">
                                <div class="location-spotify">
                ...
                <section class="section-work" id="sectionwork">
                    ...
                    <div class="cards-work5">
                        <div class="job-card-spotify">
                            ...
                            <divh5 class="location-salary-spotify">
                                <div class="location-spotify">
                                    <span class="icon-spotify">📍</span>
                                    <span>Banten City</span>
                                </div>
